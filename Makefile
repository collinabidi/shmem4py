...
all: shmem_scalar_lib1.o shmem_scalar_lib1.so
...
shmem_scalar_lib1.o: scalar_mult.c
	oshcc -shared -fPIC -o shmem_scalar_lib1.o scalar_mult.c utils.c
	@echo "== DONE MAKING shmem_scalar_lib1.o =="

shmem_lib:
	oshcc -shared -fPIC -o shmem_lib1.o utils.c
	oshcc -shared -fPIC -o shmem_lib1.so shmem_lib1.o
